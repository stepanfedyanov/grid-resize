<template>
    <div class="split-panel" @mousemove="dragMove" @mouseup="dragStop"
        ...
        <div class="split-panel-gutter" @mousedown="dragStart"
            :style="layoutType == 'horizontal' ? { width: gutterSizeString } : { height: gutterSizeString }"></div>
        <div class="split-panel-part"
